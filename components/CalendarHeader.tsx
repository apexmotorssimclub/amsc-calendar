        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-2xl md:text-4xl font-bold text-white mb-2 flex items-center">
              <div className="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center mr-2 md:mr-4 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg shadow-lg">
                <i className="ri-trophy-line w-5 h-5 md:w-6 md:h-6 flex items-center justify-center text-white"></i>
              </div>
